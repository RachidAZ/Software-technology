  ...
  <div class="row">
	<div class="col-sm-3">
      ...
      <ul class="nav nav-stacked">
        ...
        <li><a href="#"  ><i class="glyphicon glyphicon-user"></i> Members</a></li>        
    ...
    <div class="col-sm-9">
      ...
      <!-- column 2 -->	
       <h3><i class="glyphicon glyphicon-dashboard"></i> Admin Control Panel - Members</h3>  
	   ...
	   <div class="row">
            <!-- center left-->	
         	<div class="col-md-7">
			  <div class="well">Members count <span class="badge pull-right"><c:out value="${MembersCount}"/></span></div>
...
<div class="container">
    <div class="row">
		<form role="form" class="col-md-9 go-right" method="post" action="addMember">
		  ...
		  <div class="form-group">
                        <!-- Button -->
                            ...
                            <button type="submit" href="addMember" class="btn btn-primary pull-right"></i> Save</button>                          
                       
                    </div>
				

				  <!-- Message , to display after add -->
		<div class="alert alert-success" role="alert" style="display: <c:out value="${added}"/>">  <strong> Well done!  </strong> You successfully added the member!
		</div>
...
<ul class="list-group">
        ...
        <c:forEach items="${listM}" var="u">

  <li class="list-group-item"> <c:out value="${u.getEmail()}"/></li>
